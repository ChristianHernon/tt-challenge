...
const CLASS_DEFS = [
  ...
  },
  {
    ...
    description: "High viscosity pump",
    icon: "pump",
  },
  {
    id: 3,
    name: "AC Induction Motor",
    description: "Standard 3-phase motor",
    icon: "motor",
  },
  {
    id: 4,
    name: "Servo Motor",
    description: "Precision servo drive",
    icon: "motor",
  },
  {
    id: 5,
    name: "Helical Gearbox",
    description: "Speed reduction gearbox",
    icon: "gearbox",
  },
  {
    id: 6,
    name: "Planetary Gearbox",
    description: "Compact reduction gearbox",
    icon: "gearbox",
  },
  {
    id: 7,
    name: "Ball Valve",
    description: "Quarter-turn shutoff valve",
    icon: "valve",
  },
  {
    id: 8,
    name: "Butterfly Valve",
    description: "Flow regulation valve",
    icon: "valve",
  },
  {
    id: 9,
    name: "Globe Valve",
    description: "Throttling control valve",
    icon: "valve",
  },
  {
    id: 10,
    name: "Belt Conveyor",
    description: "Flat belt transport conveyor",
    icon: "conveyor",
  },
  {
    id: 11,
    name: "Screw Conveyor",
    description: "Auger-style material mover",
    icon: "conveyor",
  },
  {
    id: 12,
    name: "Bucket Elevator",
    description: "Vertical material lift",
    icon: "conveyor",
  },
  {
    id: 13,
  ...
  },
  {
    id: 14,
    name: "Thermocouple",
    description: "Type-K temperature sensor",
    icon: "sensor",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    description: "Accelerometer vibration monitor",
    icon: "sensor",
  },
  {
    id: 17,
    name: "Flow Meter",
    description: "Volumetric flow measurement",
    icon: "sensor",
  },
  {
    id: 18,
    name: "Load Cell",
    description: "Strain gauge weight sensor",
    icon: "sensor",
  },
  {
    id: 19,
  ...
  },
  {
    id: 20,
    name: "Soft Starter",
    description: "Reduced voltage motor starter",
    icon: "drive",
  },
  {
    id: 21,
    name: "PLC Module",
    description: "Programmable logic controller I/O",
    icon: "controller",
  },
  {
    id: 22,
    name: "HMI Panel",
    description: "Operator interface touchscreen",
    icon: "controller",
  },
  {
    id: 23,
    name: "Pneumatic Cylinder",
    description: "Linear pneumatic actuator",
    icon: "actuator",
  },
  {
    id: 24,
    name: "Solenoid Valve",
    description: "Electrically actuated valve",
    icon: "valve",
  },
];
...
function generateSubassemblies(parentId, friendlyParts, count) {
  ...
  for (const name of chosen) {
    const code = name.substring(0, 3).toUpperCase();
    const id = addAsset(name, `${name} sub-assembly`, "subassembly", parentId, [
      ...friendlyParts,
      code,
    ]);
    // L7 components
...
function generateEquipment(parentId, areaCode, friendlyParts) {
  ...
  for (const name of chosen) {
    ...
    const id = addAsset(name, `${name} equipment unit`, "equipment", parentId, [
      ...friendlyParts,
      code,
    ]);
...
function generateHierarchy() {
  // L1: Enterprise root
  const rootId = addAsset(
    ENTERPRISE.name,
    "Global pet food manufacturing enterprise",
    ENTERPRISE.icon,
    null,
    ["ACME"],
  );
  ...
  for (const site of SITES) {
    const siteId = addAsset(
      site.name,
      `${site.name} manufacturing facility`,
      site.icon,
      rootId,
      [site.code],
    );
...
console.log(
  `  Distinct names: ${distinctNames} (duplicate factor: ${(assets.length / distinctNames).toFixed(1)}x)`,
);
